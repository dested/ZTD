    ...
    /*    public class MyStyle
        {
            ...
            public int ZTDBottom
            {
                get { return (int)props["ZTDBottom"]; }
                set
                {
                    if (props["ZTDBottom"] == null) someCouner++;
                    props["ZTDBottom"] = value;
                }
            }
            public int ZTDHeight
            {
                get { return (int)props["ZTDHeight"]; }
                set
                {
                    if (props["ZTDHeight"] == null) someCouner++;
                    props["ZTDHeight"] = value;
                }
            }
            public int ZTDLeft
            {
                get { return (int)props["ZTDLeft"]; }
                set
                {
                    if (props["ZTDLeft"] == null) someCouner++;
                    props["ZTDLeft"] = value;
                }
            }
            public int ZTDRight
            {
                get { return (int)props["ZTDRight"]; }
                set
                {
                    if (props["ZTDRight"] == null) someCouner++;
                    props["ZTDRight"] = value;
                }
            }
            public int ZTDTop
            {
                get { return (int)props["ZTDTop"]; }
                set
                {
                    if (props["ZTDTop"] == null) someCouner++;
                    props["ZTDTop"] = value;
                }
            }
            public int ZTDWidth
            {
                get { return (int)props["ZTDWidth"]; }
                set
                {
                    if (props["ZTDWidth"] == null) someCouner++;
                    props["ZTDWidth"] = value;
                }
            }
